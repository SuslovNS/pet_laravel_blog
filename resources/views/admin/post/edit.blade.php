            ...
            <div class="row">
                <div class= "col-12">
                    ...
                    <form action="{{route('admin.post.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Теги</label>
                            <select class="select2" name="tag_ids[]" multiple="multiple" data-placeholder="Выберете теги" style="width: 100%;">
                                @foreach($tags as $tag)
...
<!--  <div class="form-group w-25">
    ...
    <input type="text" class="form-control" name="title" placeholder="Текст поста"
           value="$post->content"
    >
</div>
error('content')
